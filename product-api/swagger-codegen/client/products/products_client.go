...
type ClientService interface {
	...
	ShowProduct(params *ShowProductParams, opts ...ClientOption) (*ShowProductOK, error)
...
/*
  ShowProduct Return a list of products from the database
*/
func (a *Client) ShowProduct(params *ShowProductParams, opts ...ClientOption) (*ShowProductOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewShowProductParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "showProduct",
		Method:             "GET",
		...
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &ShowProductReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	success, ok := result.(*ShowProductOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for showProduct: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
